...
public class DirectRabbitConfig {
    ...
    //队列
    @Bean
    public Queue CalonDirectQueueOne() {
        return new Queue("CalonDirectQueueOne",true);
    }
...
//绑定
    ...
    Binding bindingDirectOne() {
        return BindingBuilder.bind(CalonDirectQueueOne()).to(CalonDirectExchange()).with("CalonDirectRouting");
    }
}
*/
